...
# Requires timewrd2ca.py to be in same folder - this has the word data in

# to shutdown hold S3 and S2 pushs for about 6 seconds
...
if len(sys.argv)==1 or sys.argv == "English":
	from timewrd2ca  import DMS_wrdck_en as DMS_wrdck

elif sys.argv[1] == "French":
	from timewrd2ca  import DMS_wrdck_fn as DMS_wrdck

elif sys.argv[1] == "Dutch":
        from timewrd2ca  import DMS_wrdck_du as DMS_wrdck
...
#confirm langage setting [ ignore the 'none' ]
print wrdck.lan()	
...
def readbright():
	try:
		...
		print
		print "bright limit file read error"
		print
		bl_lev = 15
